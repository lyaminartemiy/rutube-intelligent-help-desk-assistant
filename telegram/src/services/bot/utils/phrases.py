...
Не стесняйтесь обращаться за помощью — мы всегда готовы оказать вам содействие!"""
    ...
    POSITIVE_ANSWER = "Спасибо за положительный отзыв! Если остались вопросы — смело задавайте!"

    NEGATIVE_ANSWER = "Спасибо за отзыв! Мы учтем это и постараемся улучшить наш сервис. Попробуйте задать уточняющий вопрос!"

    DISLIKE_LIMIT = "Похоже, что у вас возникли трудности. Мы свяжемся с вами для решения проблемы. Вы также можете написать нам на почту support@example.com."
